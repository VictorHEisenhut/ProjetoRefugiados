...
create table tb_postos_saude(
id int not null auto_increment,
primary key(id)
);
create table tb_consulados(
id int not null auto_increment,
primary key(id)
);

alter table tb_abrigos add column tb_enderecos_id int;
alter table tb_abrigos add constraint fk_endereco foreign key(tb_enderecos_id) references tb_enderecos(id);

alter table tb_postos_saude add column tb_enderecos_id int;
alter table tb_postos_saude add constraint fk_endereco_ps foreign key(tb_enderecos_id) references tb_enderecos(id);

alter table tb_consulados add column tb_enderecos_id int;
alter table tb_consulados add constraint fk_endereco_c foreign key(tb_enderecos_id) references tb_enderecos(id);
...
create table tb_cadastros_filhos(
id int not null auto_increment,
nome varchar(45) not null,
nascimento date not null,
nacionalidade varchar(45) not null,
...
alter table tb_cadastros add column tb_cadastros_filhos_id int;
alter table tb_cadastros add constraint fk_filhos foreign key(tb_cadastros_filhos_id) references tb_cadastros_filhos(id);
...
rg varchar(45),
cnh varchar(45),
registro_emigrante varchar(45),
crnm varchar(45),
rne varchar(45),
dprnm varchar(45),
protocolo_refugio varchar(21),
primary key(id)
);

alter table tb_cadastros add column sobrenome varchar(45);
alter table tb_cadastros drop column nacionalidade;
alter table tb_cadastros_filhos drop column nacionalidade;

alter table tb_cadastros add column tb_documentos_id int;
alter table tb_cadastros add constraint fk_documentos foreign key(tb_documentos_id) references tb_documentos(id);

alter table tb_cadastros add column tb_paises_id int;
alter table tb_cadastros add constraint fk_paises foreign key(tb_paises_id) references tb_paises(id);

alter table tb_cadastros_filhos add column tb_paises_id int;
alter table tb_cadastros_filhos add constraint fk_paises_filhos foreign key(tb_paises_id) references tb_paises(id);
...
INSERT INTO tb_paises (id, pais ,country) VALUES
