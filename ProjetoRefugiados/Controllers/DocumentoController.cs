...
namespace ProjetoRefugiados.Controllers
{
    public class DocumentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cpf,Rg,Cnh,RegistroEmigrante,Crnm,Rne,Dprnm,ProtocoleRefugio")] Documento documento, int id)
        {
            Refugiado refugiado = _context.Refugiados.FirstOrDefault(r => r.Id == id);
            refugiado.Documento = documento;
            refugiado.DocumentoId = documento.Id;
